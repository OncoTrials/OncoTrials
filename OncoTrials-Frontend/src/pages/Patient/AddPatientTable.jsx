...
function AddPatientTable({ trials }) {
    ...
    return (
        <>
            {trials && trials.length > 0 ? (
                <div className=''>
                    <table className='w-full min-w-[950px] h-[550px] table-auto'>
                        <thead>
                            ...
                            {paginatedData.length > 0 ? (
                                paginatedData.map((trial) => (
                                    <tr key={trial.id} className='border-b hover:bg-sky-200/20 cursor-pointer' onClick={() => openModal(trial)}>
                                        <td className='px-6 font-semibold'>{trial.title}</td>
                                        <td className='px-6'>
                                        ...
                                        <td className='px-4'>{trial?.eligibility_criteria?.slice(0,100)}...</td>
                                        {/* <td className='px-6'>
                                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-sm font-semibold ${trial.status === 'Open' ? 'bg-green-200 text-black' : trial.trial_status === 'Recruiting' ? 'bg-yellow-200 text-black' : 'bg-red-200 text-black'}`}>
